...
const firstParentElem = document.querySelector('.company__title');
// 변경할 h1 태그 선택
const titleItem = document.querySelector('.company__title h1');
// companyMenu 배열의 서브메뉴를 생성하는 함수를 정의
const firstParentElemSub = document.querySelector('.company__title__menu');
function addSubMenu() {
...
// 클릭이 되어야하는 요소들 선택
const subMenuList = document.querySelectorAll('.company__title__menu li');
...
const parentElement = document.querySelector('.company__container__content');
